...
traj = Trajectory('GrpLasso_Std_Balanced')

traj.f_load(filename='./selection/randomized/experiments/hdf5/GrpLasso_Std_Balanced.hdf5',
...
df.to_csv('selection/randomized/experiments/hdf5/posterior-stdized.csv')
