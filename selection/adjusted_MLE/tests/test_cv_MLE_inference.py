...
def output_file(n=300, p=100, rho=0.35, s=150, beta_type=5, snr_values=np.array([0.10, 0.15, 0.20, 0.25, 0.30,
                                                                                 0.35, 0.42, 0.71, 1.22, 2.07]),
                target="selected", tuning_nonrand="lambda.theory", tuning_rand="lambda.theory",
                randomizing_scale=np.sqrt(0.50), ndraw = 100, outpath = None, plot=False):
