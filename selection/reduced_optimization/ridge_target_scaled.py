...
class selection_probability_lasso(rr.smooth_atom):
    ...
    def __init__(self,
        ...
        cube_obj = neg_log_cube_probability(self.q, lagrange[~active], randomization_scale=.7)
    ...
    def smooth_objective(self, param, mode='both', check_feasibility=False):
        ...
        if mode == 'func':
            ...
            #print("break up of grad", self.active_conj_loss.smooth_objective(param, 'grad'),
            #      self.cube_loss.smooth_objective(param, 'grad'),
            #      self.likelihood_loss.smooth_objective(param, 'grad'),
    ...
    def minimize2(self, step=1, nstep=100, tol=1.e-6):
        ...
        #print("gradient", grad(current))
        #print("break up of grad", self.active_conj_loss.smooth_objective(current, 'grad'),
        #      self.cube_loss.smooth_objective(current, 'grad'),
        #      self.likelihood_loss.smooth_objective(current, 'grad'),
        #      self.nonnegative_barrier.smooth_objective(current, 'grad'))
...
class sel_prob_gradient_map_lasso(rr.smooth_atom):
    ...
    def smooth_objective(self, true_param, mode='both', check_feasibility=False, tol=1.e-8):
        ...
        #print("mean_parameter", mean_parameter)
