...
from selection.reduced_optimization.ridge_target_scaled import nonnegative_softmax_scaled, neg_log_cube_probability, selection_probability_lasso, \
    sel_prob_gradient_map_lasso, selective_inf_lasso
...
def randomized_lasso_trial(X,
    ...
    sel = selection(X, y, random_Z, randomization_scale =0.7)
    ...
    if sel is not None:
        ...
        randomizer = randomization.isotropic_gaussian((p,), 0.7)
