...
# def generate_signals(inpath, V, null_prob=0.90, detection_frac = 0.44, false_frac= 0.20, sigma=1.):
# 
...
def generate_signals(inpath, V, null_prob, detection_frac = 1., false_frac= 0.18, sigma=1.):
