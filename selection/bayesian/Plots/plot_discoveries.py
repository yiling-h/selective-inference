...
def plot_discoveries(infile1, infile2, outpath):
    ...
    sns.barplot(x="snr", y="true_screen", hue_order=order, hue="method", data=df, ax=ax2, palette=cols)
    sns.barplot(x="snr", y="true_dtotal", hue_order=order, hue="method", data=df, ax=ax3, palette=cols)
