...
from ..randomized_LASSO import lasso, full_targets, selected_targets, debiased_targets
from .sim_instance import gaussian_instance
    ...
    for i in range(nsim):
        if full:
            if n > p:
                ...
                full_dispersion = False
            p0, cover_, intervals = test_Full_targets(n=n, p=p, s=s, full_dispersion=full_dispersion, CV=False)
...
if __name__ == "__main__":
    main(nsim=100, full=False, plot_ECDF=True)